...
namespace PresentationLayer
{
    public partial class Bills : Form
    {
        ...
        private void dgvBills_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Stuff stuff = stuffBusiness.GetAllStuffs().FirstOrDefault(s => s.Id == ApplicationLayer.Properties.Settings.Default.UserId);
            BillPanel bp = new BillPanel(bill,billItemBusiness,articleBusiness,stuff.Username);
            bp.ShowDialog();
