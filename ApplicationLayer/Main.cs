...
namespace PresentationLayer
{
    ...
    public partial class Main : Form
    {
        ...
        private void buttonPay_Click(object sender, EventArgs e)
        {
            ...
            Bill b = new Bill();
            b.Id_Stuff = ApplicationLayer.Properties.Settings.Default.UserId;
            b.Date = DateTime.Now;
            b.Total = sum;
            this.billBusiness.InsertBill(b);
            b.Id = billBusiness.GetNewBillId();

            Stuff stuff = stuffBusiness.GetAllStuffs().FirstOrDefault(s => s.Id == b.Id_Stuff);
            ...
            BillPanel bp = new BillPanel(b, billItemBusiness, articleBusiness, stuff.Username);
            bp.ShowDialog();
            dgBill.Rows.Clear();
        }
